...
try {
    ...
    $mail->Host = 'mail.vukpetrovic.com/rs';  // Specify main and backup SMTP servers
    ...
    $mail->Subject = 'Nova poruka sa sajta od - '.$data['email'];
    $mail->Body    = '<div style="color:red"><div>Ime i Prezime: '.$data['fullname'].'</div><div>Telefon: '.$data['phone'].'</div><div>Poruka: '.$data['message'].'</div></div>';
